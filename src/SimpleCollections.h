...
#ifndef TASKMANAGER_IO_COLLECTIONS_H
#define TASKMANAGER_IO_COLLECTIONS_H
...
namespace ioaTreeInternal {
    ...
    private:
        bool checkCapacity();
        void *memoryOf(void *baseMem, bsize_t item) const { return static_cast<uint8_t*>(baseMem) + (item * sizeOfAnItem); }
    };
}
