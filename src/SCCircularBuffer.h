...
#ifndef TASKMANAGERIO_CIRCULARBUFFER_H
#define TASKMANAGERIO_CIRCULARBUFFER_H
 ...
 */
    ...
    public:
        ...
        [[nodiscard]] bool available() const { return actingAsMemoryPool || readerPosition != writerPosition; }
